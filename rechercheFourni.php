                                        ...
                                        <legend>Recherche</legend>
                                            ...
                                            ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><a class="btn btn-success" href="modifier_produit_form.php?prodid=<?php echo $row1['prodid'] ?>">Modifer</a> </td>
                                                                            <td><a class="btn btn-danger" href="supprimer_produit.php?prodid=<?php echo $row1['prodid'] ?>">Supprimer</a> </td>
                                                                        </tr>
                                            ...
                                            <?php                   }
                                                                    ...
                                                                    $SQL2="SELECT produits.prodid,produits.nom,produits.description,produits.qte,produits.prix,produits.catid,produits.fournid FROM produits WHERE  produits.nom = '".$rech."' OR produits.description = '".$rech."' OR produits.prodid = '".$rech."'";
                                            ...
                                            ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><a class="btn btn-success" href="modifier_produit_form.php?prodid=<?php echo $row2['prodid'] ?>">Modifer</a> </td>
                                                                                    <td><a class="btn btn-danger" href="supprimer_produit.php?prodid=<?php echo $row2['prodid'] ?>">Supprimer</a> </td>
                                                                                </tr>
